      ...
      <div className="gradient-overlay min-h-screen py-8">
        <div className="container mx-auto px-6">
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-4xl font-bold text-white text-shadow">{t('marketplace.title')}</h1>
            ...
            {products.map((product) => (
              <div key={product.id} className="glass-morphism rounded-xl overflow-hidden card-hover">
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600 text-sm mb-2">{t('marketplace.product.by')} {product.farmer}</p>
                  ...
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <span className="text-sm text-gray-600">{t('marketplace.product.available')}: {product.available}</span>
                  </div>
                  <button
